...
function SPclock(parent, hOffset, vOffset, zOrder, scale) {
	...
	o.zOrder = zOrder;
    	...
    	dayOfWeek = newImage(frame, 55, 95, 64, 37, base + "sunday.png", zOrder,255),
    	rim = newImage(frame, 0, 0, 182, 182, base + "rim.png", zOrder + 1,255),
    	clock = newImage(frame, 0, 0, 182, 182, base + "clock.png", zOrder + 1,255),
